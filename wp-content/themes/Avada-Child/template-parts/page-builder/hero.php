...
$img_html = wp_get_attachment_image($image_id, 'full', false, ['class'=> $args['class_root'] . '__image']);
        ...
        <div class="cols">
            <div class="col col__text">
                <div class="col-inner">
                    ...
                    <?php } ?>
                    <h1 class="section-header"><?php echo $title ?></h1>
                    <?php if( $sub_title ){ ?>
                        <p class="below-header"><?php echo $sub_title ?></p>
                    <?php }
                    ?>
                    <div class="body">
                        <?php echo $body; ?>
