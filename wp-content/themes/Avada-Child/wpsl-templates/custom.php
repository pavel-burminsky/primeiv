...
$wpsl_settings = apply_filters('tmm_store_locator_settings_in_template', $wpsl_settings);

$output         = $this->get_custom_css(); 
$autoload_class = ( !$wpsl_settings['autoload'] ) ? 'class="wpsl-not-loaded"' : '';

$output .= '<div id="wpsl-wrap">' . "\r\n";
$output .= "\t" . '<div class="wpsl-wrap-custom-right-column"><div class="wpsl-search wpsl-clearfix ' . $this->get_css_classes() . '">' . "\r\n";
$output .= "\t\t" . '<div id="wpsl-search-wrap">' . "\r\n";
$output .= "\t\t\t" . '<form id="wpsl-form-search-form" autocomplete="off">' . "\r\n";
...
$output .= "\t\t\t\t" . '<input id="wpsl-search-input" type="text" value="' . apply_filters( 'wpsl_search_input', '' ) . '" name="wpsl-search-input" placeholder="Search zip code, city, or state" aria-required="true" />' . "\r\n";
$output .= "\t\t\t" . '</div>' . "\r\n";
...
$output .= "\t" . '<div id="wpsl-gmap" class="wpsl-gmap-canvas"></div></div>' . "\r\n";
