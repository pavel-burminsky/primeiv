    ...
    <div class="fusion-rollover-content">
        ...
        <?php if ( ! $in_cart ) : ?>
            ...
            <?php if ( $display_post_title ) : 
                $rollover_title = ( function_exists( 'FusionBuilder' ) && FusionBuilder()->post_card_data['is_rendering'] && is_tax() ) ? single_term_title( '', false ) : wp_kses_post( get_the_title( $post_id ) );
                ...
                <h4 class="fusion-rollover-title">
                    <a class="fusion-rollover-title-link" href="<?php echo esc_url_raw( $icon_permalink ); ?>"<?php echo $link_target; // phpcs:ignore WordPress.Security.EscapeOutput ?>>
                        <?php echo apply_filters('primeiv_archive_title_rollover_title', $rollover_title);?>
                    </a>
                </h4>
            <?php endif; ?>
